...
// Protective measure for SQL query injection
$folderId = htmlspecialchars($folderId, ENT_QUOTES, 'UTF-8');

// Modify SQL to filter passwords based on folder ID or display all if no folder ID
$sql = "
SELECT p.id, p.website_name, p.username, p.password, p.website_url, p.folder, p.icon_image,
       p.icon_file_name, p.date_created, fd.folder_name
FROM tbl_save_passwords p
LEFT JOIN tbl_favorites f ON p.id = f.password_id
LEFT JOIN tbl_folder fd ON p.folder = fd.folder_id
WHERE :folderId IS NULL OR p.folder = :folderId
        ...
        <section class="content">
            <div class="password-header">
                ...
                <div class="view-toggle">
                    ...
                    // Using a static ID as placeholder, adjust as necessary
