document.addEventListener('DOMContentLoaded', function () {
    ...
    /*============ Modal Functionality Start Here ============*/
        ...
        fetch('insert_password.php', {
            ...
            .then(data => {
                if (data.status === 'success') {
                    ...
                    refreshPasswordList(); // Refresh the list after adding
                } else {
    ...
    /*============ Save Button Functionality End Here ============*/
        ...
        fetch('includes/get_passwords.php')
            ...
            .then(data => {
                if (data.status === 'success') {
                    ...
                    setupEyeButtonClickHandlers();
                    setupViewButtonClickHandlers();
                    setupEditButtonClickHandlers(); // Reattach edit button handlers
                    updatePagination(); // Update pagination after refreshing the list
                } else {
    ...
    /*============ Pagination Logic End Here ============*/
     ...
     document.querySelector('.cancel-button').addEventListener('click', closeDeleteModalFunc);
     ...
     confirmDeleteButton.addEventListener('click', function () {
         ...
         .then(data => {
             if (data.status === 'success') {
                 $.notify(data.message, "success");
                 refreshPasswordList(); // Refresh the list after deleting
             } else {
                 $.notify(data.message, "error");
             }
         })
