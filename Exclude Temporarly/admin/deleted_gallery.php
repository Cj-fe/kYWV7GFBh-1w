...
<script>
    $(document).ready(function () {
        ...
        $('#delete-all').on('click', function (event) {
            ...
            $('.deleteItemName').text('All Gallery Deleted Item Records');
        ...
        $('#genericDeleteForm').on('submit', function (event) {
            ...
            $.ajax({
                type: 'POST',
                url: 'delete_all_archive_gallery_list.php', // The URL of your PHP script for deleting all alumni
                dataType: 'json',
                success: function (response) {
        ...
        $('#retrieve-all').on('click', function (event) {
            ...
            // Set a generic message or item name for the modal
            $('.restoreItemName').text('Restore All Gallery Deleted Records');
        ...
        $('#genericRestoreForm').on('submit', function (event) {
            ...
            $.ajax({
                type: 'POST',
                url: 'restore_all_archive_gallery_list.php', // The URL of your PHP script for retrieving all alumni
                dataType: 'json',
                success: function (response) {
